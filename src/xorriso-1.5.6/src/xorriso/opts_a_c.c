                            ...
                            int flag)
{
 ...
 char abort_on_text_long[SfileadrL] = {0};
 strncpy(abort_on_text_long, xorriso->abort_on_text, sizeof(abort_on_text_long)-1);  //pvmk - pacify compiler warning
 
 if(Sfile_str(abort_on_text_long, official, 0) <= 0)
   return(-1);
 
 strncpy(xorriso->abort_on_text, abort_on_text_long, sizeof(xorriso->abort_on_text)-1);  //pvmk - pacify compiler warning
