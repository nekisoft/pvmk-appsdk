...
static original_ob_t original_targets[] = {
	// Left side of map -
	{TARGET,  191, 1, 0, 0, FACTION_PLAYER3, 0},
	{TARGET,  284, 3, 0, 0, FACTION_PLAYER3, 0},
	{FLOCK,   370, 0, 370, 2630, FACTION_NONE, 0},
	{TARGET,  409, 1, 0, 0, FACTION_PLAYER3, 0},
	{TARGET,  539, 1, 0, 0, FACTION_PLAYER3, 0},
	{PLANE,   588, 0, 0, 1154, FACTION_PLAYER3, 0},
	{TARGET,  685, 3, 0, 0, FACTION_PLAYER3, TRANSFORM_MIRROR},
	{TARGET,  807, 0, 0, 0, FACTION_PLAYER3, 0},
	{TARGET,  934, 1, 0, 0, FACTION_PLAYER3, 0},

	// Player 1 base
	{FLOCK,  1000, 0, 370, 2630, FACTION_NONE, 0},
	{TARGET, 1210, 2, 0, 0, FACTION_PLAYER1, 0},
	{TARGET, 1240, 0, 0, 0, FACTION_PLAYER1, 0},
	{PLANE,  1270, 0,  901, 1835, FACTION_PLAYER1, 0},
	{PLANE,  1330, 0,  901, 1835, FACTION_PLAYER5, 0}, // Extra planes for multiplayer
	{PLANE,  1360, 0,  901, 1835, FACTION_PLAYER6, 0},
	{OX,     1376, 0, 0, 0, FACTION_NONE, 0},
	{TARGET, 1440, 3, 0, 0, FACTION_PLAYER1, 0},

	// Player 2 base
	{TARGET, 1550, 3, 0, 0, FACTION_PLAYER2, TRANSFORM_MIRROR},
	{OX,     1608, 0, 0, 0, FACTION_NONE, 0},
	{FLOCK,  1630, 0, 370, 2630, FACTION_NONE, 0},
	{PLANE,  1630, 1, 1155, 2089, FACTION_PLAYER7, 0}, // Extra planes for multiplayer
	{PLANE,  1660, 1, 1155, 2089, FACTION_PLAYER8, 0},
	{PLANE,  1720, 1, 1155, 2089, FACTION_PLAYER2, 0},
	{TARGET, 1750, 0, 0, 0, FACTION_PLAYER2, 0},
	{TARGET, 1780, 2, 0, 0, FACTION_PLAYER2, 0},
	{TARGET, 2024, 1, 0, 0, FACTION_PLAYER2, 0},

	// Right side of map -
	{TARGET, 2159, 1, 0, 0, FACTION_PLAYER4, 0},
	{TARGET, 2279, 3, 0, 0, FACTION_PLAYER4, TRANSFORM_MIRROR},
	{TARGET, 2390, 3, 0, 0, FACTION_PLAYER4, 0},
	{PLANE,  2456, 1, 2089, 9999, FACTION_PLAYER4, 0},
	{TARGET, 2549, 0, 0, 0, FACTION_PLAYER4, 0},
	{FLOCK,  2630, 0, 370, 2630, FACTION_NONE, 0},
	{TARGET, 2678, 0, 0, 0, FACTION_PLAYER4, 0},
	{TARGET, 2763, 1, 0, 0, FACTION_PLAYER4, 0},
};
