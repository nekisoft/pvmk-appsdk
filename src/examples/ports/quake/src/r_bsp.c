...
void R_DrawSolidClippedSubmodelPolygons (model_t *pmodel)
{
	...
	int			numsurfaces;
	mplane_t	*pplane;
	static mvertex_t	bverts[MAX_BMODEL_VERTS]; //static - betopp
	static bedge_t		bedges[MAX_BMODEL_EDGES], *pbedge; //static - betopp
...
void R_RenderWorld (void)
{
	int			i;
	model_t		*clmodel;
	static btofpoly_t	btofpolys[MAX_BTOFPOLYS]; //betopp - static
