...
{
  { "Red 1",       { {33, 0, 0}, {29, 0, 0}, {25, 0, 0}, {21, 0, 0}, {17, 0, 0}, {13, 0, 0}, { 9, 0, 0}, { 5, 0, 0} } },
  { "Red 2",       { {28, 0, 0}, {23, 0, 0}, {18, 0, 0}, {14, 0, 0}, {12, 0, 0}, {10, 0, 0}, { 8, 0, 0}, { 5, 0, 0} } },
  { "Red 3",       { {18, 0, 0}, {15, 0, 0}, {13, 0, 0}, {10, 0, 0}, { 8, 0, 0}, { 5, 0, 0}, { 3, 0, 0}, { 0, 0, 0} } },

  { "Green 1",     { { 0,33, 0}, { 0,29, 0}, { 0,25, 0}, { 0,21, 0}, { 0,17, 0}, { 0,13, 0}, { 0, 9, 0}, { 0, 5, 0} } },
  { "Green 2",     { { 0,28, 0}, { 0,23, 0}, { 0,18, 0}, { 0,14, 0}, { 0,12, 0}, { 0,10, 0}, { 0, 8, 0}, { 0, 5, 0} } },
  { "Green 3",     { { 0,18, 0}, { 0,15, 0}, { 0,13, 0}, { 0,10, 0}, { 0, 8, 0}, { 0, 5, 0}, { 0, 3, 0}, { 0, 0, 0} } },

  { "Blue 1",      { { 0, 0,33}, { 0, 0,29}, { 0, 0,25}, { 0, 0,21}, { 0, 0,17}, { 0, 0,13}, { 0, 0, 9}, { 0, 0, 5} } },
  { "Blue 2",      { { 0, 0,28}, { 0, 0,23}, { 0, 0,18}, { 0, 0,14}, { 0, 0,12}, { 0, 0,10}, { 0, 0, 8}, { 0, 0, 5} } },
  { "Blue 3",      { { 0, 0,18}, { 0, 0,15}, { 0, 0,13}, { 0, 0,10}, { 0, 0, 8}, { 0, 0, 5}, { 0, 0, 3}, { 0, 0, 0} } },

  { "Purple 1",    { {33, 0,33}, {29, 0,29}, {25, 0,25}, {21, 0,21}, {17, 0,17}, {13, 0,13}, { 9, 0, 9}, { 5, 0, 5} } },
  { "Purple 2",    { {28, 0,28}, {23, 0,23}, {18, 0,18}, {14, 0,14}, {12, 0,12}, {10, 0,10}, { 8, 0, 8}, { 5, 0, 5} } },
  { "Purple 3",    { {18, 0,18}, {15, 0,15}, {13, 0,13}, {10, 0,10}, { 8, 0, 8}, { 5, 0, 5}, { 3, 0, 3}, { 0, 0, 0} } },

  { "Gray 1",      { {33,33,33}, {28,28,28}, {23,23,23}, {18,18,18}, {15,15,15}, {12,12,12}, {10,10,10}, { 8, 8, 8} } },
  { "Gray 2",      { {28,28,28}, {23,23,23}, {18,18,18}, {14,14,14}, {12,12,12}, {10,10,10}, { 8, 8, 8}, { 5, 5, 5} } },
  { "Gray 3",      { {18,18,18}, {15,15,15}, {13,13,13}, {10,10,10}, { 8, 8, 8}, { 5, 5, 5}, { 3, 3, 3}, { 0, 0, 0} } },

  { "Gray/blue 1", { {23,23,33}, {20,20,29}, {18,18,26}, {15,15,23}, {12,12,20}, {10,10,17}, { 8, 8,14}, { 5, 5,10} } },
  { "Gray/blue 2", { {18,18,28}, {16,16,25}, {14,14,23}, {12,12,20}, {10,10,17}, { 8, 8,15}, { 6, 6,12}, { 4, 4, 9} } },
  { "Gray/blue 3", { {13,13,23}, {12,12,21}, {10,10,19}, { 9, 9,17}, { 7, 7,14}, { 6, 6,12}, { 4, 4,10}, { 3, 3, 8} } },

  { "Yellowish 1", { {37,32,11}, {33,28,10}, {29,24, 9}, {25,21, 8}, {21,17, 7}, {17,13, 6}, {14, 9, 4}, {11, 6, 2} } },
  { "Yellowish 2", { {33,28, 9}, {29,24, 8}, {25,21, 7}, {21,17, 6}, {17,13, 5}, {14, 9, 4}, {11, 6, 2}, {11, 4, 1} } },
  { "Yellowish 3", { {29,24, 7}, {25,21, 6}, {21,17, 5}, {17,13, 4}, {14, 9, 3}, {11, 6, 2}, { 9, 4, 1}, {11, 2, 0} } },

  { "Brown 1",     { {33,17, 0}, {29,15, 0}, {25,13, 0}, {21,11, 0}, {17, 9, 0}, {13, 7, 0}, { 9, 5, 0}, { 5, 3, 0} } },
  { "Brown 2",     { {28,14, 0}, {23,12, 0}, {18, 9, 0}, {14, 7, 0}, {12, 6, 0}, {10, 5, 0}, { 8, 4, 0}, { 5, 3, 0} } },
  { "Brown 3",     { {18, 9, 0}, {15, 8, 0}, {13, 7, 0}, {10, 5, 0}, { 8, 4, 0}, { 5, 3, 0}, { 3, 2, 0}, { 0, 0, 0} } },

  { "Cyan 1",      { { 0,33,33}, { 0,29,29}, { 0,25,25}, { 0,21,21}, { 0,17,17}, { 0,13,13}, { 0, 9, 9}, { 0, 5, 5} } },
  { "Cyan 2",      { { 0,28,28}, { 0,23,23}, { 0,18,18}, { 0,14,14}, { 0,12,12}, { 0,10,10}, { 0, 8, 8}, { 0, 5, 5} } },
  { "Cyan 3",      { { 0,18,18}, { 0,15,15}, { 0,13,13}, { 0,10,10}, { 0, 8, 8}, { 0, 5, 5}, { 0, 3, 3}, { 0, 0, 0} } },
};
...
static TMapObject mapItems[] =
{
  ...
  { OFSPIC_CABINET, OFSPIC_WRECKEDCABINET, 8, 6, 20,
    MAPOBJ_INSIDE | MAPOBJ_ONEWALLPLUS | MAPOBJ_INTERIOR | MAPOBJ_FREEINFRONT },
...
// Used-to-be blow-ups
  ...
  { OFSPIC_LABTABLE, OFSPIC_WRECKEDSAFE, 8, 6, 60,
    MAPOBJ_INSIDE | MAPOBJ_ONEWALLPLUS | MAPOBJ_INTERIOR | MAPOBJ_FREEINFRONT | MAPOBJ_POISONOUS },
...
{ OFSPIC_KEYCARD_YELLOW, OFSPIC_KEYCARD_GREEN, OFSPIC_KEYCARD_BLUE, OFSPIC_KEYCARD_RED };

static int dungeonKeys[4] =
{ OFSPIC_KEY_YELLOW, OFSPIC_KEY_GREEN, OFSPIC_KEY_BLUE, OFSPIC_KEY_RED };

static int plainKeys[4] =
{ OFSPIC_KEY3_YELLOW, OFSPIC_KEY3_GREEN, OFSPIC_KEY3_BLUE, OFSPIC_KEY3_RED };

static int cubeKeys[4] =
{ OFSPIC_KEY4_YELLOW, OFSPIC_KEY4_GREEN, OFSPIC_KEY4_BLUE, OFSPIC_KEY4_RED };
...
static struct DoorPic officeDoors[6] =
...
static struct DoorPic dungeonDoors[6] =
...
static struct DoorPic pansarDoors[6] =
...
static struct DoorPic alienDoors[6] =
...
int objectiveColors[ OBJECTIVE_MAX] =
{ 14, 16, 22, 31, 39 };
...
{
  SetCharacter( index, b->facePic, b->skinColor, b->hairColor, b->bodyColor, b->armColor, b->legColor);
...
static void SetupBadguysForMission( struct Mission *mission )
{
  ...
  for (i = 0; i < gMission.missionData->objectiveCount; i++)
    ...
    {
      b = &s->characters[ gMission.missionData->objectives[i].index % s->characterCount];
...
static void SetupObjective( int o, struct Mission *mission )
{
  ...
  gMission.objectives[o].blowupObject = &mapItems[ mission->objectives[o].index % ITEMS_COUNT];
  gMission.objectives[o].pickupItem = pickupItems[ mission->objectives[o].index % PICKUPS_COUNT];
}
...
static void SetupWeapons( int weapons )
{
  ...
  for (i = 0; i < GUN_COUNT && gMission.weaponCount < WEAPON_MAX; i++)
    if ((weapons & (1 << i)) != 0)
    {
      gMission.availableWeapons[ gMission.weaponCount] = i;
...
void SetupMission( int index, int buildTables )
{
  ...
  m = &gCampaign.setting->missions[ abs(index) % gCampaign.setting->missionCount];
  gMission.missionData = m;
  gMission.doorPics = doorStyles[ abs(m->doorStyle) % DOORSTYLE_COUNT];
  gMission.keyPics = keyStyles[ abs(m->keyStyle) % KEYSTYLE_COUNT];
  gMission.objectCount = m->itemCount;

  for (i = 0; i < m->itemCount; i++)
    gMission.mapObjects[i] = &mapItems[ abs(m->items[i]) % ITEMS_COUNT];

  srand( 10*index + gCampaign.seed);

  gMission.exitPic = exitPics[ 2*(abs(m->exitStyle) % EXIT_COUNT)];
  gMission.exitShadow = exitPics[ 2*(abs(m->exitStyle) % EXIT_COUNT) + 1];
  if (m->exitLeft > 0)
  {
  ...
  {
    if (m->mapWidth)
      x = (rand() % (abs(m->mapWidth) - EXIT_WIDTH)) + (XMAX - abs(m->mapWidth))/2;
    else
      x = rand() % (XMAX - EXIT_WIDTH);
    if (m->mapHeight)
      y = (rand() % (abs(m->mapHeight) - EXIT_HEIGHT)) + (YMAX - abs(m->mapHeight))/2;
    else
