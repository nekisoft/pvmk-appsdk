...
print_usage (int bad)
{
  ...
  fprintf (usageto, _("Tell Bryan <betopp@betopp.com> if this doesn't work. It's probably not a GNU Make problem. Otherwise, report bugs to <bug-make@gnu.org>\n"));
...
#endif
{
 ...
 /* Get rid of any avoidable limit on stack size.  */
  ...
  /* The cast to void shuts up compiler warnings on systems that
     disable NLS.  */
  //(void)bindtextdomain (PACKAGE, LOCALEDIR); //pvmk - don't care
  //(void)textdomain (PACKAGE); //pvmk - don't care
